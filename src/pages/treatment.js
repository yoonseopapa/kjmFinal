...
<nav className="navg">
    ...
    <div className="features acne">
        ...
        <br/>리쥬란힐러는 PDRN(polydeoxyribonucleotide)성분으로 우리 몸의 DNA합성을 도와
        <br/>주는 역할로, 피부의 자가 치유능력을 활성화시키고, 피부 속 진피층의 환경을 개선하여
        <br/>노화로 인한 다양한문제인 주름이나 모공, 각질, 탄력저하 등이 복합적으로 개선되는효  
        <br/>과를 보이게 됩니다.쥬베룩(Jeuvelook)은 피부세포의 근본적인 재생을 도와 피부 속부
        <br/>터 건강하게 활성화를 유도하여 젊고 건강한 피부로 되돌려주는 새로운 개념의 콜라겐
